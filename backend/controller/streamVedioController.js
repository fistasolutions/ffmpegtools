...
const convertStream = (req, res) => {
    ...
    form.parse(req, async (err, fields, files) => {
        ...
        console.log('[Streaming Info] Parsed files:', files);
        ...
        try {
            console.log('[Streaming Info] Uploading video chunk to Cloudinary...');
            ...
            // Log the result URL and send a success response
